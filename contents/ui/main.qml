    ...
    compactRepresentation: Loader {
        ...
        TapHandler {
            property bool wasExpanded: false
                ...
                wasExpanded = googletranslaterroot.expanded;
            }
            onTapped: googletranslaterroot.expanded = !wasExpanded
        }
        ...
        Item {
            ...
            WebEngineView {
                ...
                readonly property bool useMinViewWidth: plasmoid.configuration.useMinViewWidthh
                    ...
                    WebEngineProfile {
                        id: googletranslaterprofile
                        httpUserAgent: getUserAgent()
                        storageName: "googletranslater"
                        offTheRecord: false
...
MouseArea {
    ...
    {
        googletranslaterwebview.goBack();
    } else if (mouse.button === Qt.ForwardButton) {
    googletranslaterwebview.goForward();
}
}
}
}
